              ...
              <CardContent className="p-4">
                <div className="space-y-2">
                  <div className="flex justify-between items-start">
                    <h3 className="font-medium truncate text-rose-900">{service.name}</h3>
                  ...
                  if (!open) setSelectedService(undefined);
                        ...
                        <DialogContent>
                          ...
                          {selectedService && <ServiceForm service={selectedService} onSuccess={handleEditSuccess} onCancel={() => setSelectedService(undefined)} />}
                        </DialogContent>
                      </Dialog>
                      
                      <Button size="icon" variant="ghost" className="h-8 w-8 text-destructive" onClick={() => setServiceToDelete(service)} disabled={isDeleting}>
      ...
      <AlertDialog open={!!serviceToDelete} onOpenChange={open => !open && setServiceToDelete(null)}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction className="bg-destructive hover:bg-destructive/90" onClick={() => serviceToDelete?.id && handleDelete(serviceToDelete.id)} disabled={isDeleting}>
